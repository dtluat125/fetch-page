      ...
      <div className="feedbacks__inner">
        {
          <div className="text-group feedbacks__text-group">
            <div className="c-h3-title c-h3-title--maintain text-group__title feedbacks__title" data-aos="fade-right">
              Client reviews and testimony
            </div>
            <div className=" c-h6-title text-group__small-text feedbacks__small-text" data-aos="fade-right">
