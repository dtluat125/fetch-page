        ...
        <div className="employees">
            <section className="employees-header">
                <div className="cus-container">
                    <Row gutter={[{xs: 21, xl:30}, 0]}>
                        <Col xs={24} xl={12} className="reach-further">
            ...
            <section className="employees-how-it-work">
                <div className="cus-container">
                    ...
                    <Row className="row-icon-3" gutter={[{xs: 21, xl:30}, 0]}>
                        <Col xs={24} xl={8}>
            ...
            <section className="employees-usp">
                <div className="cus-container-fluid">
                    <Row className="row-top" gutter={0}>
                        <Col className="usp-col-top-left" xs={24} xl={12}>
                        ...
                        <Col className="usp-col-top-right" xs={24} xl={12} >
                            <div className="col-6-wrap">
                    ...
                    <Row className="row-bottom" gutter={0}>
                        <Col className="usp-col-bt-left" xs={24} xl={12} >
                            <div className="col-6-wrap">
                                <img src={uspBLbanner} alt="" />
                            </div>
                        </Col>
                        <Col className="usp-col-bt-right" xs={24} xl={12} >
                            <Row className="row-cus" gutter={[{xs: 21, xl:30}, 0]}>
                                <Col className="col-10-cus" span={20} offset={4}>
            ...
            <section className="employees-member">
                <div className="cus-container">
                    <Row className="first-row" justify="center" gutter={[{xs: 21, xl:30}, 0]}>
                        <Col className="first-row-col-center" xs={24} xl={12}>
                            <h1>500+</h1>
                    ...
                    <Row className="second-row" gutter={[{xs: 21, xl:30}, 0]}>
                        <Col className="second-row-col-half" xs={24} xl={12}>
                    ...
                    <Row className="third-row" gutter={[{xs: 21, xl:30}, 0]} justify="center">
                        <Col className="col-10" xs={24} xl={20} >
            ...
            {/* <section className="employees-join">
                <div className="cus-container">
                    <Row justify="center" gutter={[{xs: 21, xl:30}, 0]}>
